...
int main(int argc, char* argv[])
{
  ...
  try {
	...
	"	d//////////////////////////////////////////////////////////////////////////////h	\n"
	"	y                           `-://+oosssssssooo+//:-`                           s	\n"
	"	y                      `-/+osssssssssssssssssssssssss+/-.                      s	\n"
	"	y                  `-/osssssssssssssssssssssssssssssssssso/-`                  s	\n"
	"	y                -+ssssssssssssssssssssssssssssssssssssssssss+-`               s	\n"
	"	y             `/osssssssssss+/:.``osssssssssso``.:/+ssssssssssso/.             s	\n"
	"	y           ./sssssssssso:.`     -ssssssssssss-     `.:+ssssssssss+.           s	\n"
	"	y         `/ssssssssso:`         +ssssssssssss+         `:osssssssss/`         s	\n"
	"	y        -ossssssss+-           `ssssssssssssss`           .+sssssssso:        s	\n"
	"	y      `+ssssssss+.             :ssssssssssssss:             .+ssssssss+`      s	\n"
	"	y     `ossssssso-               osssssssssssssso               -ossssssso.     s	\n"
	"	y    .osssssss+`               -ssssssssssssssss-               `+ssssssso.    s	\n"
	"	y   `osssssss/                 +ssssssssssssssss+                 /ssssssso`   s	\n"
	"	y   +sssssss/                 `ssssssssssssssssss`                 /ssssssso   s	\n"
	"	y  :sssssss+                  /ssssssss//ssssssss/                  +sssssss/  s	\n"
	"	y `osssssso`                  ossssssss.-sssssssso                  `osssssso` s	\n"
	"	y :sssssss/                  -sssssssso  ossssssss-                  :sssssss: s	\n"
	"	y +sssssss.                  +ssssssss:  /ssssssss+                  `ssssssso s	\n"
	"	y osssssso                  .sssssssss`  .sssssssss.                  osssssss`s	\n"
	"	y`ssssssso                  /ssssssss+    +ssssssss/                  +sssssss.s	\n"
	"	y`ssssssso                 `ossssssss-    :sssssssso`                 +sssssss.s	\n"
	"	y osssssso                 -sssssssso`    `ossssssss:                 osssssss`s	\n"
	"	y +sssssss.                +ssssssss/      /sssssssso                `ssssssso s	\n"
	"	y :sssssss/               .sssssssss.      -sssssssss.               :sssssss: s	\n"
	"	y `osssssss`              /sssssssssoooooooosssssssss/              `osssssso` s	\n"
	"	y  :sssssss+             `osssssssssssssssssssssssssso`             +sssssss/  s	\n"
	"	y   +sssssss/            :ssssssssssssssssssssssssssss:            /ssssssso   s	\n"
	"	y   `osssssss/           osssssssssssssssssssssssssssso           /ssssssso.   s	\n"
	"	y    .osssssss+`        .ssssssssssssssssssssssssssssss.        `+ssssssso.    s	\n"
	"	y     .ossssssso-       /ssssssssssssssssssssssssssssss+       -ossssssso.     s	\n"
	"	y      `+ssssssss+.    `sssssssss/            /sssssssss`    .+ssssssss+`      s	\n"
	"	y        :ossssssss+-  :sssssssss-            -sssssssss:  .+sssssssso:        s	\n"
	"	y         `/ssssssssso:osssssssso              osssssssso:osssssssss+`         s	\n"
	"	y           .+ssssssssssssssssss/              :ssssssssssssssssss+.           s	\n"
	"	y             ./osssssssssssssss-              -ssssssssssssssso/.             s	\n"
	"	y               `-+sssssssssssssssoo++////++oosssssssssssssss+-`               s	\n"
	"	y                  `-/osssssssssssssssssssssssssssssssssso+-`                  s	\n"
	"	y                      .-/osssssssssssssssssssssssssso/:.                      s	\n"
	"	y                           .-:/++oossssssssoo++/:-.                           s	\n"
	"	d:::::::::::::::::::::::::::::::::::://////::::::::::::::::::::::::::::::::::::h	\n" << ENDL;
